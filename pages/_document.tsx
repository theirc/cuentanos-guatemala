  ...
  return (
    <Html>
      <Head>
        ...
        />
        <meta property="og:title" content="Cuentanos Guatemala" />
        <meta property="og:description" content="Cuentanos Guatemala website" />
        <meta
          property="og:image"
          content="https://guatemala.cuentanos.org/api/og-image"
        />
        <script
